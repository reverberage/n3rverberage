"""Local provider implementation (Ollama / vLLM / local endpoints)."""
...
class LocalProvider(ModelProvider):
    """Provider for local or self-hosted OpenAI-compatible endpoints.

    Examples: Ollama, vLLM, LM Studio, llama.cpp server.
    No API key is required — uses ``"not-needed"`` as a placeholder.
    """
